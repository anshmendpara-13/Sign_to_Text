...
class Application:
    ...
    def __init__(self):
        ...
        file1 = "Models/model_new.json"
        self.json_file = open(file1, "r")
        self.model_json = self.json_file.read()
        self.json_file.close()

        self.loaded_model = model_from_json(self.model_json)
        file2 = "Models/model_new.h5"
        self.loaded_model.load_weights(file2)

        file3 = "Models/model-bw_dru.json"
        self.json_file_dru = open(file3, "r")
